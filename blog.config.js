...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1c0ca329acce80dda2e5e2e2f2381f15,en:1c0ca329acce80dda2e5e2e2f2381f15',
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'ru-RU', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Я просто хочу быть счастливым', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://vlafriday.space', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'vlafriday, Тот самый Фрайдей', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://beian.miit.gov.cn/', // 备案查询链接，如果用了萌备等备案请在这里填写

  // RSS订阅
  ENABLE_RSS: process.env.NEXT_PUBLIC_ENABLE_RSS || false, // Включить ли функцию подписки RSS
  ...
  GREETING_WORDS:
    ...
    'Привет，я тестировщик, Привет，я исследователь, Привет，я энтузиаст, Привет，я инвестор, Просто добро пожаловать в мой мир...',
